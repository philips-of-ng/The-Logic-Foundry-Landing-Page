    ...
    <section className="bg-[#0A0A0A] text-white py-32 px-6 border-t border-white/5 relative overflow-hidden flex items-center justify-center min-h-[600px]">
      ...
      >
        ...
        <div className="relative w-full mb-8 flex justify-center items-center">
          ...
          >
            READY TO WRITE <span className="block">YOUR FIRST LINE</span>{" "}
            <span className="text-[#B8FF35] block md:inline">OF CODE?</span>
          </motion.h2>
        </div>
        ...
        >
          ...
          Secure your spot today and take the first step toward building the
          digital future.
        </motion.p>
